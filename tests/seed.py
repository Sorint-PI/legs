...
def keycloak_create_realm():
    ...
    response_post = requests.post('http://localhost:8080/admin/realms', headers=headers, json=json_data)
    response_get = requests.get('http://localhost:8080/admin/realms/' + keycloak_realm_name, headers=headers)
...
def keycloak_create_realm_ldap_federation():
    ...
    response = requests.post('http://localhost:8080/admin/realms/'+keycloak_realm_name+'/components', headers=headers, json=json_data)
